...
class Ingredient_Courses_4 extends StatelessWidget {
  ...
  Widget _buildCourses(BuildContext context, int index) {
    ...
    onTap: (){
      ingredient4_index=index;
    Navigator.pop(context);
    Navigator.push(context, MaterialPageRoute(builder: (context) => ingredientInside(value: 4,),maintainState: false));
    },
      child: Container(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: Text(ingredient_num_4[sorted_id4[index]],
                      style: TextStyle(
                        color:Colors.white,
                  ...
                  Text(
                    ingredient_name_4[sorted_id4[index]].toString(),
                    style: TextStyle(
                      fontWeight: FontWeight.w600,
                      fontSize: 18.sp,
                    ),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        new LinearPercentIndicator(
                          width: width * 0.36,
                          lineHeight: 20.0,
                          percent: exp_day(ingredient_exp_4[sorted_id4[index]]),
                          center: Text(
                            Remainder(ingredient_exp_4[sorted_id4[index]]),
          ...
          Expanded(
              child: Container(
                child: GridView.builder(
                  ...
                  itemCount: ingredient_name_4.length,
