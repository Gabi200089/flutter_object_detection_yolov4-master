...
class Ingredient_Courses_3 extends StatelessWidget {
  ...
  Widget _buildCourses(BuildContext context, int index) {
    ...
    onTap: (){
      ingredient3_index=index;
    Navigator.pop(context);
    Navigator.push(context, MaterialPageRoute(builder: (context) => ingredientInside(value: 3,),maintainState: false));
    },
      child: Container(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: Text(ingredient_num_3[sorted_id3[index]],
                      style: TextStyle(
                        color:Colors.white,
                  ...
                  Text(
                    ingredient_name_3[sorted_id3[index]].toString(),
                    style: TextStyle(
                      fontWeight: FontWeight.w600,
                      fontSize: 18.sp,
                    ),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        new LinearPercentIndicator(
                          width: width * 0.36,
                          lineHeight: 20.0,
                          percent: exp_day(ingredient_exp_3[sorted_id3[index]]),
                          center: Text(
                            Remainder(ingredient_exp_3[sorted_id3[index]]),
