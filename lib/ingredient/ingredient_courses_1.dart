...
class Ingredient_Courses_1 extends StatelessWidget {
  ...
  Widget _buildCourses(BuildContext context, int index) {
    ...
    onTap: (){
      ingredient1_index=index;
    Navigator.pop(context);
    Navigator.push(context, MaterialPageRoute(builder: (context) => ingredientInside(value: 1,),maintainState: false));
    },
      child: Container(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: Text(ingredient_num_1[sorted_id1[index]],
                      style: TextStyle(
                        color:Colors.white,
                  ...
                  Text(
                    ingredient_name_1[sorted_id1[index]].toString(),
                    style: TextStyle(
                      fontWeight: FontWeight.w600,
                      fontSize: 18.sp,
                    ),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        new LinearPercentIndicator(
                          width: width * 0.36,
                          lineHeight: 20.0,
                          percent: exp_day(ingredient_exp_1[sorted_id1[index]]),
                          center: Text(
                            Remainder(ingredient_exp_1[sorted_id1[index]]),
          ...
          Expanded(
              child: Container(
                child: GridView.builder(
                  ...
                  itemCount: ingredient_name_1.length,
