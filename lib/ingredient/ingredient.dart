...
class _IngredientState extends State<Ingredient> {
  ...
  String urlvalue="";
  String urlDownload="";
  String selected_url="https://firebasestorage.googleapis.com/v0/b/imagetotextconverterapp-3953b.appspot.com/o/ingredient.png?alt=media&token=70f0c615-bb7f-41bc-864c-f9000beadcc6";
                  ...
                  child: Stack(
                    ...
                    children: [
                      Container(
                        ...
                        width: 320/w*_width,
                        decoration: BoxDecoration(
                            border: Border.all(color: Colors.transparent, width: 0/w*_width),
                                ...
                                Container(
                                  ...
                                  child:  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                        contentPadding: EdgeInsets.symmetric(horizontal: 40.0/w*_width),
    ...
    if(_txtExp.text=="")
    {
      ...
      if (file == null) {
            ...
            .then((value) =>
        {
          ...
          Alert(
              context: context, title: "圖片上傳中....", desc: "請稍候😃", buttons: [])
              .dismiss();
          Navigator.pop(context);
          Navigator.push(context, MaterialPageRoute(
              builder: (context) => ingredient_management(),
              maintainState: false));
        });
      };
